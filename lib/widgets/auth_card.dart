...
class _AuthCardState extends State<AuthCard>
  ...
  Widget build(BuildContext context) {
    ...
    final bool isMobile = DeviceType.isMobile == Utils.getDevice(context);

    if (_authMode == AuthMode.Signup) {
      cwidth = isMobile ? width * 0.7 : width * 0.5;
      cheight = height * 0.8;
    } else {
      cwidth = isMobile ? width * 0.7 : width * 0.5;
      cheight = height * 0.6;
                      ...
                      Hero(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset("assets/images/img_login.jpeg",
                                fit: BoxFit.cover, width: width * 0.2),
                          )),
  ...
  Widget buildformfield(TextEditingController controllerName, String label,
    ...
    return TextFormField(
      ...
      validator: validator,
      keyboardType:
          label == 'Phone' ? TextInputType.number : TextInputType.emailAddress,
  ...
  buildloginButton(BuildContext context, VoidCallback opFunct, String text) {
    return Material(
